 ...
 * @abstract      : Contus HD Video Share Recent Videos Module
...
<div class="module_menu <?php echo $class;?> module_videos">
    <!-- Code begin here for recent videos in home page display  -->
        <div class="video-grid-container clearfix" >
            ...
            <?php }
            if (($i % $sidethumbview['siderecentvideocol']) == 0 && $i != 0) { ?>
            </ul>
            <ul class="ulvideo_thumb clearfix">
                <?php } ?>
                    <?php
                    ...
                    ?>
                           <div class="mod_video_item">
                            <a class=" info_hover featured_vidimg" rel="htmltooltip" href="<?php echo JRoute::_("index.php?option=com_contushdvideoshare&amp;view=player&amp;" . $recentVideoVal . "&amp;" . $recentCategoryVal); ?>" ><img class="yt-uix-hovercard-target" src="<?php echo $src_path; ?>"   title="" alt="thumb_image" /></a>
                           </div>
                         <div class="floatleft video-item-details">
                                <div class="show-title-container title">
                                    <a href="<?php echo JRoute::_("index.php?option=com_contushdvideoshare&amp;view=player&amp;" . $recentVideoVal . "&amp;" . $recentCategoryVal); ?>" class="show-title-gray info_hover"><?php if (strlen($result[$i]->title) > 30) { echo JHTML::_('string.truncate', ($result[$i]->title), 30); } else { echo $result[$i]->title; } ?></a>
                                </div>
                                      ...
                                      { ?>
                                          <div class="htmltooltip">
                                            ...
                                            <div class="tooltip_views_right">
                                             ...
                                             <div id="htmltooltipwrapper5<?php echo $i; ?>">
...
<div class="morevideos">
    <a href="<?php echo JRoute::_("index.php?option=com_contushdvideoshare&view=recentvideos"); ?>"><?php echo JText::_('HDVS_MORE_VIDEOS'); ?></a></div><?php } ?>
<div class="clear"></div>
