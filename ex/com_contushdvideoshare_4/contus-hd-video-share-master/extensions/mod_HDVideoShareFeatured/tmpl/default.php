 ...
 * @abstract      : Contus HD Video Share Featured Videos Module
...
<div class="module_menu <?php echo $class;?> module_videos">
    <!-- Code begin here for featured videos in home page display  -->
        <div class="video-grid-container clearfix" >
            ...
            <?php }
            if (($i % $sidethumbview['sidefeaturedvideocol']) == 0 && $i != 0) { ?>
            </ul>
            <ul class="ulvideo_thumb clearfix">
                <?php } ?>
                    <?php
                    ...
                    ?>
                           <div class="mod_video_item">
                            <a class=" info_hover featured_vidimg" rel="htmltooltip" href="<?php echo JRoute::_("index.php?option=com_contushdvideoshare&amp;view=player&amp;" . $featuredVideoVal . "&amp;" . $featuredCategoryVal); ?>" ><img class="yt-uix-hovercard-target" src="<?php echo $src_path; ?>"   title="" alt="thumb_image" /></a>
                           </div>
