...
$style = '#video-grid-container .ulvideo_thumb .video-item{margin-right:'.$thumbview['recentwidth'] . 'px; }';
                            ...
                            ?>
                             <li class="video-item">
                               <div class="list_video_thumb">
                                     <a class="featured_vidimg" rel="htmltooltip" href="<?php echo 'index.php?option=com_contushdvideoshare&view=player&'.$recentCategoryVal.'&'.$recentVideoVal; ?>" >
                                 ...
                                 <div class="video_thread">
                                    <div class="show-title-container">
                                        ...
                                        <?php
                                                    if (strlen($this->recentvideos[$i]->title) > 50)
                                                    {
                                                        echo JHTML::_('string.truncate', ($this->recentvideos[$i]->title), 50);
                                                    }
                                                    else
                                                    {
...
<?php } ?>
                                    ...
                                    ?>
                                                            ...
                                                            <span class="floatright viewcolor"><?php echo $this->recentvideos[$i]->times_viewed; ?> <?php echo JText::_('HDVS_VIEWS'); ?></span></div>
                                                       <?php } ?>
                                                        </li>
                            <?php
                                                    if ($colcount == 0)
                      ...
                      for ($i = 0; $i < $totalrecords; $i++)
                                      { ?>
                                          <div class="htmltooltip">
                                              <?php if($this->recentvideos[$i]->description) {?>
                                             ...
                                             <div class="tooltip_category_left">
                                                 ...
                                                 <span class="show_category"><?php echo $this->recentvideos[$i]->category; ?></span>
                                             </div>
                                             <?php if ($dispenable['viewedconrtol'] == 1) { ?>
                                            <div class="tooltip_views_right">
                                                 <span class="view_txt"><?php echo JText::_('HDVS_VIEWS'); ?>: </span>
                                                 <span class="view_count"><?php echo $this->recentvideos[$i]->times_viewed; ?> </span>
                                             </div>
             ...
             <!--Tooltip end Here-->
                                            ...
                                            <ul class="hd_pagination">
                                               <?php
                                                $pages='';
                                               if(isset($this->recentvideos['pages']))
                                                $pages = $this->recentvideos['pages'];
                                               if(isset($this->recentvideos['pageno'])){
