...
<style>#toolbar-box,#submenu-box {display: none;}</style>
	...
	<div id="cpanel">
		...
		<div class="icon">
			<a
				...
				title="Admin Videos" alt="Admin Videos"> <span>Admin Videos</span> </a>
		</div>
		...
		<div class="icon">
			<a
				...
				title="Category" alt="Category"> <span>Category</span> </a>
		</div>
		...
		<div class="icon">
			<a
				...
				title="ads" alt="ads"> <span>Video Ads</span> </a>
		</div>
...
<!-- control panel second column view start here -->
	...
	<table class="adminlist">
		...
		<?php foreach($popularvideos as $details) { ?>
			<tr>
				...
				?> <a href="<?php echo $route; ?>" target="_blank"><?php  echo $details->title; ?>
				</a>
				</td>
...
<!-- control panel second column view end -->